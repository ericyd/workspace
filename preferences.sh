...
git config --global alias.l1 "log --abbrev-commit --decorate --date=short --format=format:'%h, %aI - %s%d' -n 1" 
git config --global alias.l2 "log --abbrev-commit --decorate --date=short --format=format:'%h, %aI - %s%d' -n 2"
git config --global alias.l3 "log --abbrev-commit --decorate --date=short --format=format:'%h, %aI - %s%d' -n 3"
git config --global alias.l4 "log --abbrev-commit --decorate --date=short --format=format:'%h, %aI - %s%d' -n 4"
git config --global alias.l5 "log --abbrev-commit --decorate --date=short --format=format:'%h, %aI - %s%d' -n 5"
